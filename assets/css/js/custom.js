...
$(document).ready(function () {
  ...
  function callToaster(positionClass) {
    ...
    toastr.success("Welcome to Balubal Library", "Hi!");
  }
  ...
  if (infoTeoaset !== null) {
    infoTeoaset.on("click", function () {
      ...
      if (thisId === "toaster-info") {
        toastr.info("Welcome to Balubal Library", "Hi!", " Info message");
      } else if (thisId === "toaster-success") {
        toastr.success("Welcome to Balubal Library", "Hi!", "Success message");
      } else if (thisId === "toaster-warning") {
        toastr.warning("Welcome to Balubal Library", "Hi!", "Warning message");
      } else if (thisId === "toaster-danger") {
        toastr.error("Welcome to Balubal Library", "Hi!", "Danger message");
      }
    });
  }
